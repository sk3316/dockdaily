...
import { calculateLongestStreak, calculateStreak } from "@/utils/streak";
...
export default function ProfileScreen() {
  const { user, profile, session, signInWithGoogle, signOut, deleteAccount } =
    useAuthStore();
      ...
      >
        <View style={styles.avatarSection}>
          {session && profile?.avatar_url ? (
            ...
            <View
              style={[styles.avatarBubble, { backgroundColor: colors.tint }]}
            >
              <Text
                style={[
        ...
        <View style={[styles.section, { borderColor }]}>
              ...
              {(["system", "light", "dark"] as const).map((t) => (
                <TouchableOpacity
                  ...
                  style={[
                    ...
                    {
                      backgroundColor:
                        theme === t ? colors.tint : "transparent",
                      borderColor,
                    },
                  ]}
                >
            ...
            <TouchableOpacity
              onPress={async () => {
                if (notificationsEnabled) {
                  ...
                  const stillOff =
                    !usePreferenceStore.getState().notificationsEnabled;
          ...
          {notificationsEnabled && (
            <>
              ...
              {timePickerOpen && (
                <View
                  style={[styles.timePicker, { borderTopColor: borderColor }]}
                >
                  ...
                  <Text style={[styles.timeSep, { color: colors.text }]}>
                    :
                  </Text>
